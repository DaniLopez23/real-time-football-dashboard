...
const CarryArrow: React.FC<CarryArrowProps> = ({
  xScale,
  yScale,
  origin,
  destination,
  ...
  const color = result === 'success' ? '#2196F3' : '#FF9800';

  return (
    <g className="carry-arrow">
      {/* Línea de conducción - intermitente (dashed) */}
      <line
        x1={x1}
        y1={y1}
        x2={x2}
