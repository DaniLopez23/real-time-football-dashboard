  ...
  return (
    <div className="h-screen w-full bg-slate-950 p-4">
      ...
      <div className="h-full flex flex-col gap-2">
        ...
        <div className="grid grid-cols-12 gap-2" style={{ height: '40%' }}>
          {/* Columna 1 - Grande */}
        ...
        {/* Fila 2: 2 columnas (mitad y mitad) - 40% de altura */}
        <div className="grid grid-cols-2 gap-2 flex-1">
          {/* Columna 1 - Mitad */}
          <div className="bg-slate-900 rounded-lg border border-slate-800 p-4">
            <h2 className="text-white text-lg font-semibold mb-2">Campograma de eventos</h2>
            <OptaPitch width={500} height={400} />
          </div>
          ...
          <div className="grid grid-rows-2 gap-2">
            {/* Subfila 1 */}
            <div className="bg-slate-900 rounded-lg border border-slate-800 p-4">
              <h2 className="text-white text-lg font-semibold mb-2">Panel 5</h2>
              <p className="text-slate-400">Contenido de la subfila 1</p>
            </div>
            
            {/* Subfila 2 */}
            <div className="bg-slate-900 rounded-lg border border-slate-800 p-4">
              <h2 className="text-white text-lg font-semibold mb-2">Panel 6</h2>
              <p className="text-slate-400">Contenido de la subfila 2</p>
            </div>
          </div>
        </div>
      </div>
